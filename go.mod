...
replace (
	...
	github.com/cockroachdb/cockroach => github.com/cockroachdb/cockroach-gen v0.0.0-20220617021006-010562535118
	vitess.io/vitess => github.com/cockroachdb/vitess v0.0.0-20210218160543-54524729cc82
)

require (
	github.com/cockroachdb/cockroach v0.0.0-20220617103221-57c79aed6a04
